import { collection, doc, query, where, getDocs, setDoc, deleteDoc, getDoc, runTransaction } from "firebase/firestore";
...
export const registerForEvent = async (userId, eventId) => {
  ...
  return await runTransaction(db, async (transaction) => {
    ...
    return { registration: registrationData, newRegisteredCount, newStatus: updateData.status || eventData.status };
  });
};
